...
class Address(db.Model):
    ...
    def __init__(self, id, postal_area):
        self.id = id
...
class Email(db.Model):
    ...
    def __init__(self, id, email, entity_id):
        self.id = id
        self.email = email
...
class Entity(db.Model):
    ...
    def __init__ (self, id, name, phone, website, is_verified):
        self.id = id
        self.name = name
    ...
    def __repr__(self):
        return "<Entity(id='%s', name='%s', website='%s', is_verified='%s')>" % (self.id, self.name, self.website, self.is_verified)
...
class EntityLanguage(db.Model):
    ...
    def __init__(self, entity_id, id, description):
        self.entity_id = entity_id
        self.id = id
        self.description = description

    def __repr__(self):
        return "<EntityLanguage(description='%s')>" % (self.description)
...
class Users(db.Model, UserMixin):
    ...
    # def __init__(self, id, email, password, active, preferred_language, roles):
    #     self.id = id
    #     self.email = email
    ...
    def __repr__(self):
        return "<Users(email='%s')>" % (self.email)
...
# Initialize the user datastore and Flask-Security
user_datastore = SQLAlchemyUserDatastore(db, Users, Users)
